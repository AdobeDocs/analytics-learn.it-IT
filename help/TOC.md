...
+ Introduzione ad Analytics {#intro-to-analytics}
   ...
   + Nozioni di base su Analytics {#analytics-basics}
      ...
      + [Informazioni sulle metriche di base del visitatore](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/metrics/understanding-basic-visitor-metrics.html)
      + [Introduzione alle variabili di traffico (Prop)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/introduction-to-traffic-variables-props.html)
      + [Introduzione alle variabili di conversione (eVars)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/introduction-to-conversion-variables-evars.html)
      + [Introduzione agli eventi di conversione](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/metrics/introduction-to-conversion-events.html)
...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Visualizzazioni {#visualizations}
      ...
      + [Visualizzazioni con superfici e superfici sovrapposte](analysis-workspace/visualizations/area-and-area-stacked.md)
      ...
      + [Aggiunta di linee di tendenza alle visualizzazioni a linee](analysis-workspace/visualizations/adding-trendlines-to-line-visualizations.md)
      + [Visualizzazione mappa](analysis-workspace/visualizations/map-visualization.md)
      + [Visualizzazioni Numero riepilogo e Modifica riepilogo](analysis-workspace/visualizations/summary-number-and-summary-change-visualizations-2021.md)
      ...
      + [Impostazioni delle origini dati per la tabella e la visualizzazione](analysis-workspace/visualizations/table-and-visualization-data-source-settings.md)
   ...
   + Curare e condividere i progetti {#curate-and-share-projects}
      ...
      + [Esportare in formato CSV da Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/from-the-ui/export-to-csv-from-analysis-workspace.html?lang=it)
...
+ Implementazione {#implementation}
   + Nozioni di base sull’implementazione {#implementation-basics}
      ...
      + [Creazione di suite di rapporti](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/analytics-basics/understanding-and-creating-report-suites.html)
   ...
   + Tramite Experience Platform Launch {#via-adobe-launch}
      + [Implementazione delle soluzioni Experience Cloud nei siti web con Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-websites-with-launch/index.html?lang=it)
...
+ Analytics per app mobili {#mobile-app-analytics}
   + Implementazione {#implementation}
      ...
      + [Implementazione nelle app iOS con Swift](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-mobile-ios-swift-apps-with-launch/index.html)
      + [Implementazione nelle app iOS con Objective-C](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-mobile-ios-objective-c-apps-with-launch/index.html)
      + [Implementazione nelle app Android](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-mobile-android-apps-with-launch/index.html)
