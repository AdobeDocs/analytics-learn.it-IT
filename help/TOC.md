...
+ Introduzione ad Analytics {#intro-to-analytics}
   + Cosa Può  Adobe Analytics Per Me? {#what-can-aa-do-for-me}
      + [ Adobe  Analysis Workspace può cambiare la vostra azienda](intro-to-analytics/what-can-aa-do-for-me/how-adobe-analysis-workspace-can-change-your-business.md)
      + [È più di dati. È l&#39;intelligence dei clienti](intro-to-analytics/what-can-aa-do-for-me/adobe-analytics-customer-intelligence.md)
      + [ Adobe Sensei e  Adobe Analytics](intro-to-analytics/what-can-aa-do-for-me/adobe-sensei-and-adobe-analytics.md)
      + [Caso di utilizzo del cliente - ServiceNow](intro-to-analytics/what-can-aa-do-for-me/servicenow-gets-the-right-insights-to-connect-with-prospects.md)
      + [Caso di utilizzo cliente - Gruppo di accenti](intro-to-analytics/what-can-aa-do-for-me/accent-group-invests-in-customer-experience-to-drive-sales.md)
      + [Caso di utilizzo del cliente - Il Deposito iniziale](intro-to-analytics/what-can-aa-do-for-me/the-home-depot-innovates-with-customer-experience-management.md)
   ...
   + Nozioni di base su Analytics {#analytics-basics}
      ...
      + [Modalità di raccolta dei dati di Analytics](intro-to-analytics/analytics-basics/how-analytics-data-is-collected.md)
      + [Accesso a  Adobe Analytics](intro-to-analytics/analytics-basics/logging-in-to-adobe-analytics.md)
   ...
   + Personalizzazione dell&#39;interfaccia {#customizing-the-ui}
      + [Aggiunta di descrizioni di Dimension e metriche](intro-to-analytics/customizing-the-ui/adding-dimension-and-metric-descriptions.md)
      + [Utilizzo delle palette Colore personalizzate in  Analysis Workspace](intro-to-analytics/customizing-the-ui/using-custom-color-palettes-in-analysis-workspace.md)
   ...
   + Guida {#getting-help}
      + [ suggerimenti Analysis Workspace per i prodotti](intro-to-analytics/getting-help/in-product-tips.md)
      + [Invio del biglietto per il supporto interno al prodotto](intro-to-analytics/getting-help/in-product-support-ticket-submission.md)
      + [Guida in linea  Adobe Analytics](intro-to-analytics/getting-help/getting-help.md)
+ Analysis Workspace {#analysis-workspace}
   +  Analysis Workspace Basics {#analysis-workspace-basics}
      ...
      + [Utilizzo di modelli personalizzati per abilitare i nuovi  utenti Analysis Workspace](analysis-workspace/analysis-workspace-basics/using-custom-templates-to-enable-novice-users.md)
      + [Informazioni Su Come I Dati Vengono Inseriti Nel Progetto Analysis Workspace ](analysis-workspace/analysis-workspace-basics/understanding-how-data-gets-into-your-analysis-workspace-project.md)
      ...
      + [Utilizzo dei manager dei componenti](analysis-workspace/analysis-workspace-basics/using-component-managers.md)
   ...
   + Navigazione nei progetti Workspace {#navigating-workspace-projects}
      ...
      + [Visualizzare la densità in  Analysis Workspace](analysis-workspace/navigating-workspace-projects/view-density-in-analysis-workspace.md)
   ...
   + Creazione di tabelle a forma libera {#building-freeform-tables}
      ...
      + [Menu di scelta rapida continuato in  Analysis Workspace](analysis-workspace/building-freeform-tables/continued-right-click-menu-in-analysis-workspace.md)
      + [Analisi cross-selling in  Analysis Workspace](analysis-workspace/building-freeform-tables/cross-sell-analysis-workspace.md)
      + [Filtri tabella a forma libera](analysis-workspace/building-freeform-tables/freeform-table-filters.md)
      + [Suddivisione dei Dimension in  Analysis Workspace](analysis-workspace/building-freeform-tables/time-parting-dimensions-in-analysis-workspace.md)
      + [Totali tabella a forma libera in  Analysis Workspace](analysis-workspace/building-freeform-tables/freeform-table-totals-in-analysis-workspace.md)
   + Visualizzazioni {#visualizations}
      ...
      + [Visualizzazioni Summary Number (Numero riepilogo) e Summary Change (Variazione riepilogo)](analysis-workspace/visualizations/summary-number-and-summary-change-visualizations.md)
      + [Utilizzo Della Funzione Media Cumulativa Per Applicare L&#39;Uniformità Metrica](analysis-workspace/visualizations/using-the-cumulative-average-function-to-apply-metric-smoothing.md)
      ...
      + [Collegamento in tempo reale con i Dimension](analysis-workspace/visualizations/dimension-graph-live-linking.md)
      + [Attiva/disattiva granularità](analysis-workspace/visualizations/granularity-toggle.md)
      + [Intra-link in  Analysis Workspace](analysis-workspace/visualizations/intra-linking-in-analysis-workspace.md)
      + [Tema mappa positiva-negativa](analysis-workspace/visualizations/positive-negative-map-theme.md)
      ...
      + [Creare una mappa di calore che suddivide il tempo](analysis-workspace/visualizations/build-a-time-parting-heatmap.md)
      + [Visualizzazioni mappa ad albero e grafico a dispersione](analysis-workspace/visualizations/treemap-and-scatterplot-visualizations.md)
      + [Visualizzazione diagramma di Venn](analysis-workspace/visualizations/venn-diagram-visualization.md)
      + [Impostazioni origine dati visualizzazione](analysis-workspace/visualizations/visualization-data-source-settings.md)
   ...
   + Cura e condivisione di progetti {#curate-and-share-projects}
      ...
      + [Condivisione di componenti incorporati](analysis-workspace/curate-and-share-projects/share-embedded-components.md)
      + [Pianificazione e scaricabilità di progetti](analysis-workspace/curate-and-share-projects/scheduled-downloadable-projects-analysis-workspace.md)
   ...
   + Attribution IQ {#attribution-iq}
      + [Utilizzo dell&#39;analisi interscheda per esplorare l&#39;attribuzione marketing di base](analysis-workspace/attribution-iq/using-cross-tab-analysis-to-explore-basic-marketing-attribution-in-analysis-workspace.md)
      + [Aggiunta di confronti affiancati di modelli di Attribution IQ ](analysis-workspace/attribution-iq/adding-side-by-side-comparisons-of-attribution-iq-models.md)
   ...
   + Analisi per coorte {#cohort-analysis}
      ...
      + [Analisi delle modifiche con le tabelle coorte](analysis-workspace/cohort-analysis/churn-analysis-with-cohort-tables.md)
      + [Analisi per coorte con qualsiasi Dimension](analysis-workspace/cohort-analysis/cohort-analysis-using-any-dimension.md)
      + [Analisi della latenza con tabelle coorte](analysis-workspace/cohort-analysis/latency-analysis-with-cohort-tables.md)
      + [Calcolo del mantenimento del rollout nelle tabelle coorte](analysis-workspace/cohort-analysis/calculate-rolling-retention-in-cohort-tables.md)
   + Analisi voce {#voice-analytics}
      + [Come gestire e tenere traccia dei dati dell&#39;app Voice Assistant](analysis-workspace/voice-analytics/how-to-manage-and-track-your-voice-assistant-app-data.md)
      + [Comprendere Le Differenze Tra Dispositivi Abilitati Per La Voce](analysis-workspace/voice-analytics/understand-differences-across-voice-enabled-devices.md)
...
+ Amministrazione {#administration}
   ...
   + Gestisci suite di rapporti {#manage-report-suites}
...
+ Implementazione {#implementation}
   + Nozioni di base sull&#39;implementazione {#implementation-basics}
      ...
      + [Mappa le variabili contextData in prop ed evar con le regole di elaborazione](implementation/implementation-basics/map-contextdata-variables-into-props-and-evars-with-processing-rules.md)
      ...
      + [Creazione e manutenzione di un DSP.](implementation/implementation-basics/creating-and-maintaining-an-sdr.md)
   ...
   + Tramite Experience Platform Launch {#via-adobe-launch}
      ...
      + [Configurazione di base dell&#39;estensione del lancio di Analytics](implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.md)
      ...
      + [Preparazione del Experience Platform Launch per l&#39;implementazione di Analytics](implementation/via-adobe-launch/preparing-adobe-launch-for-your-analytics-implementation.md)
      + [Creazione di elementi dati nel Experience Platform Launch per l&#39;implementazione di Analytics](implementation/via-adobe-launch/creating-data-elements-in-launch-for-the-analytics-implementation.md)
      + [Creazione di una regola di pagina globale nel Experience Platform Launch](implementation/via-adobe-launch/creating-a-global-page-rule-in-launch.md)
      + [Convalida della regola di caricamento pagina globale nel Experience Platform Launch](implementation/via-adobe-launch/validating-your-global-page-load-rule-in-launch.md)
      + [Creazione di regole di Experience Platform Launch per le pagine speciali](implementation/via-adobe-launch/creating-launch-rules-for-special-pages.md)
      + [Creazione di regole di Experience Platform Launch per gli eventi di successo](implementation/via-adobe-launch/creating-launch-rules-for-success-events.md)
      + [Pubblicazione di librerie di Experienci Platform Launch su stage e produzione](implementation/via-adobe-launch/publishing-launch-libraries-to-stage-and-production.md)
   + Utilizzo di JavaScript {#using-javascript}
      + [Tracciamento personalizzato dei collegamenti senza Gestione tag](implementation/using-javascript/custom-link-tracking-without-a-tag-manager.md)
      + [Aggiornamento di AppMeasurement quando non si utilizza il Experience Platform Launch](implementation/using-javascript/updating-appmeasurement-when-not-using-adobe-launch.md)
...
+ Componenti {#components}
   + Segmentazione {#segmentation}
      ...
      + [Segmentazione sui conteggi dei Dimension distinti](components/segmentation/segmentation-on-distinct-dimension-counts.md)
   ...
   + Metriche calcolate {#calculated-metrics}
      + [Funzione di identificazione del conteggio approssimativo nelle metriche calcolate](components/calculated-metrics/approximate-count-distinct-function-in-calculated-metrics.md)
      + [ Attribution IQ nelle metriche calcolate](analysis-workspace/attribution-iq/attribution-iq-in-calculated-metrics.md)
      ...
      + [Metriche calcolate - Selettore metrica](components/calculated-metrics/calculated-metrics-metric-selector.md)
      ...
      + [Utilizzo degli Dimension nelle metriche calcolate](components/calculated-metrics/using-dimensions-in-calculated-metrics.md)
   + Classificazioni {#classifications}
      ...
      + [Utilizzo di Generatore regole di classificazione](components/classifications/using-the-classification-rule-builder.md)
   + Suite di rapporti virtuali {#virtual-report-suites}
      ...
      + [Avvia una nuova visita su qualsiasi evento nelle suite di rapporti virtuali](components/virtual-report-suites/start-a-new-visit-on-any-event-in-virtual-report-suites.md)
   + Activity Map {#activity-map}
      + [Panoramica sui Activity Map ](components/activity-map/activity-map-overview.md)
      + [Abilitazione, debug e personalizzazione del Activity Map  Adobe Analytics ](components/activity-map/enabling-debugging-and-customizing-the-activity-map.md)
+ Strumenti aggiuntivi {#additional-tools}
   + Dashboard di Analytics {#analytics-dashboards}
      ...
      + [Analisi di dashboard Esperienza in-app](additional-tools/analytics-dashboards/adobe-analytics-dashboards-in-app-experience.md)
+ Esportazione di {#exporting}
   + Dall&#39;interfaccia {#from-the-ui}
      + [Esportazione in formato CSV da  Analysis Workspace](exporting/from-the-ui/export-to-csv-from-analysis-workspace.md)
   + Data Warehouse {#data-warehouse}
      + [Introduzione alla Data Warehouse](exporting/data-warehouse/introduction-to-data-warehouse.md)
   + Feed dati {#data-feeds}
      + [Interfaccia utente di gestione feed dati](exporting/data-feeds/data-feeds-management-ui.md)
   + Report Builder {#report-builder}
      + [Aggiunta di segmenti a più richieste contemporaneamente al Report Builder](exporting/report-builder/add-segments-to-multiple-requests-at-once-in-report-builder.md)
      + [Rilevamento delle anomalie nel Report Builder](exporting/report-builder/anomaly-detection-in-report-builder.md)
      + [Modifica metriche tra le richieste](exporting/report-builder/edit-metrics-across-requests.md)
      + [Utilizzo di Report Builder per apprendere l&#39;API Adobe Analytics ](exporting/report-builder/using-report-builder-to-learn-the-adobe-analytics-api.md)
+ Integrazioni {#integrations}
   ...
   + Audience Manager {#audience-manager}
      + [Abilita inoltro lato server nel Experience Platform Launch](integrations/audience-manager/enable-server-side-forwarding-in-adobe-launch.md)
      + [Audience Analytics  - Integrazione AAM segmenti in Analytics](integrations/audience-manager/audience-analytics-integrate-aam-segments-into-analytics.md)
   + Target {#target}
   ...
   + Ad Cloud {#ad-cloud}
      + [Configurazione  Advertising Analytics](integrations/ad-cloud/configuring-advertising-analytics.md)
      ...
      + [Introduzione ad Analytics per  integrazione con Advertising Cloud DSP](integrations/ad-cloud/introduction-to-the-analytics-for-advertising-cloud-dsp-integration.md)
      + [Creazione di un&#39;analisi campagna di pre-avvio](integrations/ad-cloud/create-a-pre-launch-campaign-analysis-with-adobe-analytics.md)
      ...
      + [Creare  dashboard Advertising Cloud](integrations/ad-cloud/create-advertising-cloud-dashboards-with-adobe-analytics.md)
   + Analisi ad hoc {#ad-hoc-analytics}
   ...
   + Magento {#magento}
      + [Magento  modello Analysis Workspace](integrations/magento/magento-analysis-workspace-template.md)
+ Data Science {#data-science}
   + [Utilizzo  Adobe Analytics machine learning e AI per i momenti che contano](data-science/using-machine-learning-and-ai-for-the-moments-that-matter.md)
...
+ Specifica verticale {#vertical-specific}
   + High Tech {#high-tech}
      + [Summit 2019 Super Session - High Tech](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-high-tech.md)
   ...
   + Vendita al dettaglio {#retail}
      ...
      + [Aggiunta di una regola di avvio per l&#39;evento di acquisto](vertical-specific/retail/adding-a-launch-rule-for-the-purchase-event.md)
      + [Summit 2019 Super Session - Retail](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-retail.md)
+ Media Analytics {#media-analytics}
   + Misurazione voce o audio {#measuring-voice-or-audio}
...
+ Analytics per app mobili {#mobile-app-analytics}
   + Implementazione {#implementation}
      ...
      + [Inizializzazione e visualizzazione delle metriche del ciclo di vita con l’SDK del Experience Platform ](mobile-app-analytics/implementation/initializing-and-viewing-lifecycle-metrics-with-the-experience-platform-sdk.md)
      + [Azioni di tracciamento (collegamenti personalizzati AKA)](mobile-app-analytics/implementation/tracking-actions-aka-custom-links.md)
      + [Stato tracciamento (pagine o schermate AKA)](mobile-app-analytics/implementation/tracking-state-aka-pages-or-screens.md)
      + [Implementazione nelle app Swift iOS](https://docs.adobe.com/content/help/it-IT/experience-cloud/implementing-in-mobile-ios-swift-apps-with-launch/index.html)
      + [Implementazione nelle app iOS Objective-C](https://docs.adobe.com/content/help/it-IT/experience-cloud/implementing-in-mobile-ios-objective-c-apps-with-launch/index.html)
...
+ Casi di utilizzo dell&#39;analisi {#analysis-use-cases}
   + [Impostazione dell’analisi del codice ZIP sul mercato](analysis-use-cases/setting-up-in-market-zip-code-analysis-use-case.md)
