...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Suggerimenti {#tips-and-tricks}
      + [Creare collegamenti ipertestuali in tabelle a forma libera](analysis-workspace/tips-and-tricks/create-hyperlinks-in-freeform-tables.md)
   ...
   + Navigazione nei progetti Workspace {#navigating-workspace-projects}
      ...
      + [Modello per tutorial di formazione](analysis-workspace/navigating-workspace-projects/training-tutorial-template-in-analysis-workspace.md)
      ...
      + [Utilizzare filtri a discesa a selezione multipla](analysis-workspace/navigating-workspace-projects/use-multi-select-drop-down-filters.md)
...
+ Componenti {#components}
   ...
   + Classificazioni {#classifications}
      ...
      + [Cronologia dei processi dei set di classificazione](components/classifications/classification-sets-job-history.md)
   ...
   + Activity Map {#activity-map}
      ...
      + [Abilitare, eseguire il debug e personalizzare Activity Map](components/activity-map/enabling-debugging-and-customizing-the-activity-map.md)
...
+ Esportazione {#exporting}
   ...
   + Feed dati {#data-feeds}
      + [Creare e gestire feed dati](exporting/data-feeds/data-feeds-management-ui.md)
   ...
   + Report Builder {#report-builder}
      + [Aggiornare e ripianificare le cartelle di lavoro](exporting/report-builder/upgrade-and-reschedule-workbooks.md)
...
+ Integrazioni {#integrations}
   ...
   + Adobe Advertising DSP {#adobe-advertising-dsp}
      ...
      + [Creare segmenti di Analytics per l’attivazione e il reporting](integrations/ad-cloud/create-analytics-segments-for-activation-and-reporting.md)
      + [Creare avvisi di Advertising DSP con Adobe Analytics](integrations/ad-cloud/create-advertising-cloud-alerts-with-adobe-analytics.md)
      + [Creare metriche personalizzate di Analytics con i dati di Advertising DSP](integrations/ad-cloud/create-analytics-custom-metrics-with-advertising-cloud-data.md)
      + [Creare rapporti sulle visite al sito in Advertising DSP](integrations/ad-cloud/create-advertising-cloud-site-entry-reports.md)
      + [Creare dashboard di Advertising DSP](integrations/ad-cloud/create-advertising-cloud-dashboards-with-adobe-analytics.md)
